...
namespace hotjuice {
	...
	public:
        ...
        virtual void prepareRenderer(void* in = nullptr, void* out = nullptr);
        virtual void updateRenderer(void* in = nullptr, void* out = nullptr);
        virtual void cleanupRenderer(void* in = nullptr, void* out = nullptr);
